  ...
  return (
    <main>
      ...
      <div className="company-detail-right">
        ...
        <Button buttonStyle = "learn-button" name="Learn More"/>
      </div>
    </main>
  );
}
      ...
      <div className="product-section-container">
        ...
        <div className="product-card-list">
          <div className="product-card">
            ...
            <Button buttonStyle = "add-to-cart-button" name ="Add to Cart"/>
          </div>
          <div className="product-card">
            <img
              src="https://placehold.co/300x300"
          ...
          <div className="product-card">
            ...
            <Button buttonStyle = "add-to-cart-button-secondary" name ="Add to Cart" />
          </div>
        </div>
      </div>
    </section>
...
function Button(props) {
  return <button className={props.buttonStyle}>{props.name}</button>;
}
